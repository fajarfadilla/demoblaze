...
WebUI.setText(findTestObject('Object Repository/UserOnboard/input_Username_loginusername'), '')

WebUI.setText(findTestObject('Object Repository/UserOnboard/input_Password_loginpassword'), '')
